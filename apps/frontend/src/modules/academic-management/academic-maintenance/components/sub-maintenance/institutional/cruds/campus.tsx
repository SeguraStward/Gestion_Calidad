...
import {
  CreateCampusInput,
  CampusWithRelations
} from '@/modules/academic-management/academic-maintenance/types/institutional/campus'
  ...
  const onSubmit = (data: CreateCampusInput) => {
    try {
      const payload: CreateCampusInput = {
        ...data,
        regionalCenter: data.regionalCenter?.connect?.id
          ? { connect: { id: data.regionalCenter.connect.id } }
          : { connect: { id: '' } }, // Ensure correct format
        classrooms: {
          ...
          <CardContent className="p-4 space-y-3">
            <div className="flex justify-between items-start">
              <div>
                ...
                {campus.regionalCenter && <p className="text-xs text-muted-foreground">Sede: {campus.regionalCenter.name}</p>}
              </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t mt-3">
              ...
              <div className="flex gap-2">
                <Button size="sm" variant="outline" onClick={() => onEdit(campus.id)}>
                  Editar
                </Button>
                <Button
                  size="sm"
