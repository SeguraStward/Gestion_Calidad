...
const {
  ...
  CampusFilters
>('campuses', campusService as GenericService<CampusWithRelations, CreateCampusInput, Partial<CreateCampusInput>, CampusFilters>, {
  messages: {
...
export function useListCampuses(
  ...
  return useQuery<CampusWithRelations[], Error, CampusWithRelations[], (string | Omit<CampusFilters, 'page' | 'limit'> | undefined)[]>({
