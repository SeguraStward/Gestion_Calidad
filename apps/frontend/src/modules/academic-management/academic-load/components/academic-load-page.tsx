    ...
    return ({ control, errors, editingItem, isUpdate, handleSubmitForm, handleCancel, isProcessing }: any) => {
      ...
      return (
        <CrudFormAdapter
          ...
          description={isUpdate ? 'Actualice los datos de la carga académica' : 'Complete los datos para registrar una nueva carga académica'}
          sections={() => [
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  name: 'scheduleId',
                  label: 'Horario',
                  options: formData.schedules.map((s: any) => ({ id: s.id, name: `${s.day || s.dayOfWeek || ''} ${s.startTime}-${s.endTime}` })),
