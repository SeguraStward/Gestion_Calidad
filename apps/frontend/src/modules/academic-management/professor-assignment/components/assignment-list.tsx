...
import { BookOpen, Users, Trash2, CheckCircle, Pencil } from 'lucide-react'
...
export const AssignmentList = ({ assignments, filter, confirmDelete, setFilter, onEdit }: AssignmentListProps) => (
    ...
    {assignments.length === 0 ? (
      ...
      <div className="space-y-3">
        {assignments.map((assignment) => (
          <Card
            key={assignment.id}
            className="flex justify-between items-center p-4 shadow-sm hover:shadow transition-all border-l-4 border-l-primary"
          >
