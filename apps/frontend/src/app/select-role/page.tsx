  ...
  return (
    <Card className="w-full">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected ? 'border-primary bg-muted' : 'border border-input hover:bg-accent hover:text-accent-foreground'
              )}
            >
              <span>{role}</span>
      ...
      <CardFooter className="pt-2">
        <Button onClick={handleSubmit} disabled={!selectedRole} className="w-full">
          Continuar
        </Button>
      </CardFooter>
    </Card>
