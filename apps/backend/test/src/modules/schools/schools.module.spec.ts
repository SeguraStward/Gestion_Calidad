...
describe('SchoolsModule (Modular)', () => {
  ...
  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      .overrideProvider(SchoolsRepository).useValue(mockRepository)
    ...
    repository = moduleFixture.get<SchoolsRepository>(SchoolsRepository) as any;
  });
  ...
  describe('Flujos HTTP - Schools', () => {
    it('POST /schools — Crea registro — responde 201', async () => {
      const createDto = { name: 'Test Schools' };
    ...
    it('GET /schools — Lista registros — responde 200', async () => {
    ...
    it('GET /schools/:id — Obtiene un registro — responde 200', async () => {
