...
describe('DocumentsModule (Modular)', () => {
  ...
  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      .overrideProvider(DocumentsRepository).useValue(mockRepository)
    ...
    repository = moduleFixture.get<DocumentsRepository>(DocumentsRepository) as any;
  });
  ...
  describe('Flujos HTTP - Documents', () => {
    it('POST /documents — Crea registro — responde 201', async () => {
      const createDto = { projectId: 'project1', sessionId: 'session1' };
    ...
    it('GET /documents — Lista registros — responde 200', async () => {
