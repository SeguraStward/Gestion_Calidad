...
describe('CoursesModule (Modular)', () => {
  ...
  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      .overrideProvider(CoursesRepository).useValue(mockRepository)
    ...
    repository = moduleFixture.get<CoursesRepository>(CoursesRepository) as any;
  });
  ...
  describe('Flujos HTTP - Courses', () => {
    it('POST /courses — Crea registro — responde 201', async () => {
      const createDto = { name: 'Test Courses' };
    ...
    it('GET /courses — Lista registros — responde 200', async () => {
