...
describe('CommissionsModule (Modular)', () => {
  ...
  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      .overrideProvider(CommissionsRepository).useValue(mockRepository)
    ...
    repository = moduleFixture.get<CommissionsRepository>(CommissionsRepository) as any;
  });
  ...
  describe('Flujos HTTP - Commissions', () => {
    it('POST /commissions — Crea registro — responde 201', async () => {
      const createDto = { name: 'Test Commissions' };
