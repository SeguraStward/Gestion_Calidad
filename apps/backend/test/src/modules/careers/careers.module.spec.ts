...
describe('CareersModule (Modular)', () => {
  let app: INestApplication;
  let repository: jest.Mocked<CareersRepository>;
  ...
  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      .overrideProvider(CareersRepository).useValue(mockRepository)
    ...
    repository = moduleFixture.get<CareersRepository>(CareersRepository) as any;
  });
  ...
  describe('Flujos HTTP - Careers', () => {
    it('POST /careers — Crea registro — responde 201', async () => {
      const createDto = { name: 'Test Careers' };
    ...
    it('GET /careers — Lista registros — responde 200', async () => {
