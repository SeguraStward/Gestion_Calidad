...
MODULES=(
  "academic-load-groups:AcademicLoadGroups:academic-load-groups:group-1"
  "academic-loads:AcademicLoads:academic-loads:load-1"
  "annual-journey-time-allocations:AnnualJourneyTimeAllocations:annual-journey-time-allocations:alloc-1"
  "campus-journey-time-allocations:CampusJourneyTimeAllocations:campus-journey-time-allocations:campus-alloc-1"
  "journey-time-configs:JourneyTimeConfigs:journey-time-configs:config-1"
)
