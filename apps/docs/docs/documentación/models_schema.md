...
- **AcademicPeriod **: Relación uno a uno con `AcademicPeriod ` a través de `termId`.
...
El modelo `AcademicPeriod ` representa un término académico y tiene las siguientes relaciones:
